...
## Design
+ FreshNews is built with Material Components for Android.
...
## Open API
FreshNews uses the NewsApi for constructing RESTful API. Obtain your free API_KEY [NewsApi](https://newsapi.org/register) and paste it to the Constants file to try the app.
